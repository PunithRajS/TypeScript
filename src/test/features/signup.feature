Feature: UPS User Sign-Up
  As a new user
  I want to sign up for a UPS account
  So that I can access UPS services and manage my shipments

  Background:
    Given I am on the UPS sign-up page
  ...
  Scenario: Successful sign-up with valid information
    ...
    And I should be redirected to the UPS home page
